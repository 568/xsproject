package com.sid.soundrecorderutils.widget;
...
/**
 * Created by lv on 19-10-30.
 * Service 控制 Widget 的更新时间
 * 在 onCreate 开启一个计时线程，每1秒发送一个广播，广播就是我们自己定义的类型。
 */

public class WidgetService extends Service {
    // 更新 widget 的广播对应的 action
    private final String ACTION_UPDATE_ALL = "com.xsrecord.widget.UPDATE_ALL";
    // 周期性更新 widget 的周期
    ...
    public void onCreate() {
        ...
        mTimerTask = new TimerTask() {
            @Override
            public void run() {
                Log.e("sr_wp", "WidgetService :"+ACTION_UPDATE_ALL);
                Intent updateIntent = new Intent(ACTION_UPDATE_ALL);
                updateIntent.setComponent( new ComponentName( "com.sid.soundrecorderutils" ,
                        "com.sid.soundrecorderutils.widget.MainWidgetProvider") );
